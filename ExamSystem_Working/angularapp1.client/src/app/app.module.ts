...
import { ResultofexamComponent } from './resultofexam/resultofexam.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path: 'result/:spec/:grade/:examid', component:ResultofexamComponent},
